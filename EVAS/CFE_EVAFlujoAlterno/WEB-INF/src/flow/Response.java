 ...
 */
public class Response extends com.avaya.sce.runtime.Return {
	...
	public java.util.Collection getOutputParams(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		param = new com.avaya.sce.runtime.Parameter("Estatus", "Estatus", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

		param = new com.avaya.sce.runtime.Parameter("ID", "ID", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);

		param = new com.avaya.sce.runtime.Parameter("Mensaje", "Mensaje", com.avaya.sce.runtime.Parameter.VARIABLE);
		list.add(param);
