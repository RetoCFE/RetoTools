...
public interface IProjectVariables {
	...
	public static final String EVA__UCID = "EVA_UCID";
	public static final String EVA__AUTOATENDIDA = "EVA_AUTOATENDIDA";
	public static final String EVA__TRANSFERENCIA = "EVA_TRANSFERENCIA";
	public static final String EVA__DNIS = "EVA_DNIS";
	public static final String REDIRECTINFO = "redirectinfo";
	public static final String SESSION = "session";
	public static final String EVA__RPU = "EVA_RPU";
	public static final String UNTITLED_INPUT_3 = "untitledInput3";
	public static final String UNTITLED_INPUT_2 = "untitledInput2";
	public static final String EVA__SESSIONID = "EVA_SESSIONID";
	public static final String EVA__PASO = "EVA_PASO";
	public static final String DD_LAST_EXCEPTION = "ddLastException";
	public static final String EVA__TELEFONO = "EVA_TELEFONO";
